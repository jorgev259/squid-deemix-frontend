...
declare module 'deezer-js' {
  ...
  class API {
    ...
    search(
      ...
      DeezerResponse<[Track | Album | Artist | Playlist | Radio | User]>
    >
    search_album(
      query: string,
      options?: QueryOptions
    ...
    search_artist(
      query: string,
      options?: QueryOptions
    ): Promise<DeezerResponse<[Artist]>>
    search_playlist(
      query: string,
      options?: QueryOptions
    ): Promise<DeezerResponse<[Playlist]>>
    search_radio(
      query: string,
      options?: QueryOptions
    ): Promise<DeezerResponse<[Radio]>>
    search_track(
      query: string,
      options?: QueryOptions
    ): Promise<DeezerResponse<[Track]>>
